export declare const syntax: {
    parse: (html: any, options?: any) => any;
    builders: {
    ...
    traverse: (node: any, visitor: any) => void;
    Walker: (order?: any) => void;
};
export declare function preprocess(html: any, options?: any): any;
export declare function Parser(source: any, options: any): void;

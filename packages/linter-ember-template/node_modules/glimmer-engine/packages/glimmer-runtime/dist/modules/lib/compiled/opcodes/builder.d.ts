...
import { AppendOpcode, ConstantArray, ConstantOther, ConstantExpression, ConstantBlock } from '../../opcodes';
...
export declare class Slice {
    ...
    constructor(ops: AppendOpcode[], start: number, end: number);
}
export declare abstract class BasicOpcodeBuilder implements SymbolLookup {
    ...
    push(op: Option<AppendOpcode>): void;
...
export default class OpcodeBuilder extends BasicOpcodeBuilder {
    ...
    preludeForLayout(layout: Layout): void;

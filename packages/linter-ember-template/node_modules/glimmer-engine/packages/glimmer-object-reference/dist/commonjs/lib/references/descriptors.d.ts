import { Reference, RevisionTag } from 'glimmer-reference';
...
export declare function ComputedReferenceBlueprint<T>(property: any, dependencies: any): InnerReferenceFactory<T>;
